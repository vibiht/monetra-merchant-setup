...
void checkModuleConstants_urllib3$filepost(void) {
    ...
    checkConstantsBlob(&mod_consts[0], "urllib3.filepost");
}
#endif
...
static PyObject *urllib3$filepost$$$function__2_iter_field_objects$$$genobj__1_iter_field_objects_context(struct Nuitka_GeneratorObject *generator, PyObject *yield_return_value) {
    ...
    branch_no_2:;
    {
...

        {
            ...
            tmp_expression_name_3 = impl___main__$$$function__5_complex_call_helper_star_list(dir_call_args);
        }
...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        UPDATE_STRING_DICT0(moduledict_urllib3$filepost, (Nuitka_StringObject *)mod_consts[43], tmp_assign_source_4);
    }
    {
        PyObject *tmp_assign_source_5;
