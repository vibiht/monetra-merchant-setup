/* Generated code for Python module 'cryptography.hazmat._types'
...
/* The "module_cryptography$hazmat$_types" is a Python object pointer of module type.
 *
...
PyObject *module_cryptography$hazmat$_types;
PyDictObject *moduledict_cryptography$hazmat$_types;
...
static void createModuleConstants(void) {
    if (constants_created == false) {
        loadConstantsBlob(&mod_consts[0], UNTRANSLATE("cryptography.hazmat._types"));
...
void checkModuleConstants_cryptography$hazmat$_types(void) {
    // The module may not have been used at all, then ignore this.
    if (constants_created == false) return;

    checkConstantsBlob(&mod_consts[0], "cryptography.hazmat._types");
}
#endif

// The module code objects.
static PyCodeObject *codeobj_2e9f53477202438d34c8149a2c3d2f40;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[28]); CHECK_OBJECT(module_filename_obj);
    codeobj_2e9f53477202438d34c8149a2c3d2f40 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[29], NULL, NULL, 0, 0, 0);
}
...
function_impl_code functable_cryptography$hazmat$_types[] = {
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    function_impl_code *current = functable_cryptography$hazmat$_types;
    int offset = 0;
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    if (offset > sizeof(functable_cryptography$hazmat$_types) || offset < 0) {
    ...
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        functable_cryptography$hazmat$_types[offset],
        code_object->co_name,
...
#endif
        module_cryptography$hazmat$_types,
        doc,
        NULL,
        0
    );
...
PyObject *modulecode_cryptography$hazmat$_types(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *module_entry) {
    module_cryptography$hazmat$_types = module;
...
#ifdef _NUITKA_TRACE
    PRINT_STRING("cryptography.hazmat._types: Calling setupMetaPathBasedLoader().\n");
#endif
...
#ifdef _NUITKA_TRACE
    PRINT_STRING("cryptography.hazmat._types: Calling createModuleConstants().\n");
#endif
    createModuleConstants();

    /* The code objects used by this module are created now. */
#ifdef _NUITKA_TRACE
    PRINT_STRING("cryptography.hazmat._types: Calling createModuleCodeObjects().\n");
#endif
    createModuleCodeObjects();

    // PRINT_STRING("in initcryptography$hazmat$_types\n");
    ...
    moduledict_cryptography$hazmat$_types = MODULE_DICT(module_cryptography$hazmat$_types);
    ...
    UPDATE_STRING_DICT0(
        moduledict_cryptography$hazmat$_types,
...
#elif 0
        PyObject *module_name = GET_STRING_DICT_VALUE(moduledict_cryptography$hazmat$_types, (Nuitka_StringObject *)const_str_plain___name__);
    ...
    CHECK_OBJECT(module_cryptography$hazmat$_types);

    // For deep importing of a module we need to have "__builtins__", so we set
    // it ourselves in the same way than CPython does. Note: This must be done
    // before the frame object is allocated, or else it may fail.

    if (GET_STRING_DICT_VALUE(moduledict_cryptography$hazmat$_types, (Nuitka_StringObject *)const_str_plain___builtins__) == NULL) {
        ...
        UPDATE_STRING_DICT0(moduledict_cryptography$hazmat$_types, (Nuitka_StringObject *)const_str_plain___builtins__, value);
    }

#if PYTHON_VERSION >= 0x300
    UPDATE_STRING_DICT0(moduledict_cryptography$hazmat$_types, (Nuitka_StringObject *)const_str_plain___loader__, (PyObject *)&Nuitka_Loader_Type);
#endif
...
// Set the "__spec__" value
    ...
    UPDATE_STRING_DICT0(moduledict_cryptography$hazmat$_types, (Nuitka_StringObject *)const_str_plain___spec__, Py_None);
#else
    // Other modules get a "ModuleSpec" from the standard mechanism.
    {
        ...
        PyObject *spec_value = CALL_FUNCTION_WITH_SINGLE_ARG(_spec_from_module, module_cryptography$hazmat$_types);
...
// Mark the execution in the "__spec__" value.
        ...
        UPDATE_STRING_DICT1(moduledict_cryptography$hazmat$_types, (Nuitka_StringObject *)const_str_plain___spec__, spec_value);
    }
#endif
#endif
    ...
    struct Nuitka_FrameObject *frame_2e9f53477202438d34c8149a2c3d2f40;
    ...
    // Module code.
    {
        ...
        UPDATE_STRING_DICT0(moduledict_cryptography$hazmat$_types, (Nuitka_StringObject *)mod_consts[0], tmp_assign_source_1);
    }
    {
    ...
    // Frame without reuse.
    frame_2e9f53477202438d34c8149a2c3d2f40 = MAKE_MODULE_FRAME(codeobj_2e9f53477202438d34c8149a2c3d2f40, module_cryptography$hazmat$_types);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_2e9f53477202438d34c8149a2c3d2f40);
    assert(Py_REFCNT(frame_2e9f53477202438d34c8149a2c3d2f40) == 2);
    ...
    }
    {
        ...
        frame_2e9f53477202438d34c8149a2c3d2f40->m_frame.f_lineno = 5;
    ...
    }
    {
        ...
        frame_2e9f53477202438d34c8149a2c3d2f40->m_frame.f_lineno = 7;
    ...
    tmp_import_from_1__module = NULL;
    {
        ...
        tmp_subscript_name_1 = PyTuple_New(5);
        {
            ...
            PyTuple_SET_ITEM(tmp_subscript_name_1, 4, tmp_tuple_element_1);
        }
    ...
    }
    {
        ...
        tmp_subscript_name_2 = PyTuple_New(5);
        {
            ...
            PyTuple_SET_ITEM(tmp_subscript_name_2, 4, tmp_tuple_element_2);
        }
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_2e9f53477202438d34c8149a2c3d2f40);
#endif
    popFrameStack();

    assertFrameObject(frame_2e9f53477202438d34c8149a2c3d2f40);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_2e9f53477202438d34c8149a2c3d2f40, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_2e9f53477202438d34c8149a2c3d2f40->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_2e9f53477202438d34c8149a2c3d2f40, exception_lineno);
    }
    ...
    return module_cryptography$hazmat$_types;
