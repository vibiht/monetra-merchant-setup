...
void checkModuleConstants_urllib3(void) {
    ...
    checkConstantsBlob(&mod_consts[0], "urllib3");
}
#endif
...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        UPDATE_STRING_DICT0(moduledict_urllib3, (Nuitka_StringObject *)mod_consts[33], tmp_assign_source_5);
    }
    {
    ...
    // Tried code:
    {
        ...
        if (PyModule_Check(tmp_import_name_from_8)) {
            ...
            tmp_assign_source_17 = IMPORT_NAME(tmp_import_name_from_8, mod_consts[53]);
        }
    ...
    }
    {
        ...
        if (PyModule_Check(tmp_import_name_from_10)) {
            ...
            tmp_assign_source_19 = IMPORT_NAME(tmp_import_name_from_10, mod_consts[55]);
        }
    ...
    }
    {
        ...
        if (PyModule_Check(tmp_import_name_from_12)) {
            ...
            tmp_assign_source_21 = IMPORT_NAME(tmp_import_name_from_12, mod_consts[61]);
        }
